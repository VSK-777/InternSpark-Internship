...
## 🚀 How to Run and Test
### 1. Database Setup
Create a local MySQL database named `task2_data_migration_db`:
```sql
...
```
Upon startup, Flyway will automatically detect the SQL files in `src/main/resources/db/migration/` and execute them in order (V1, V2, V3). 
